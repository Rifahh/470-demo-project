...
<div class="checkout-container">
 ...
 <!-- personal note: cchanging the value of the form: change log v1

  to the: checkout lower case:
    name=checkout lower 
    !-->
    
   <form method="get" action="{{ route('checkout')}}">    <!--this if codition will work if the cart is not empty or cart total is zero-->
